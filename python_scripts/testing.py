...
def train(config, dset_loaders):
    ...
    for itr in range(config["num_iterations"]):
        ...
        base_network_source.train(True)
        # ad_net.train(True)
...
def parge_args():
    ...
    parser.set_defaults(
        ...
        tv_dset_txt="../../data/office/txt_files/A10.txt",
        t_dset_txt="../../data/office/txt_files/A90.txt",
        source_model_path="/home/venom/PycharmProjects/MDNETS-V2.0/experiments/python_scripts/experiments/models/office/ResNet50/train_D_CNN/best_model.pth.tar",
        s_dset="W",
        t_dset="A",
        lr=0.001,
        arch="ResNet50",
