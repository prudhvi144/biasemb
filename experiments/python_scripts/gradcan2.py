...
# Modefied under Apache License, Version 2.0 by the prudhvi thitumalaraju 1/16/2022
# Copyright (C) 2020-2021, Prudhvi Thirumalaraju.
# Edited based on MDNETS scripts by: Prudhvi Thirumalaraju.
...
def load_model(model_root,dset):
    model_path = model_root + '/' + dset + '/' + "best_model.pth.tar"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--arch", type=str, default='resnet50', help="Name of the architecture")
    parser.add_argument("--img", type=str,
                        default='/home/venom/PycharmProjects/MDNETS-V2.0/data/office/dslr/images/mouse/frame_0001.jpg',
                        help="The image to extract CAM from")
    parser.add_argument("--class-idx", type=int, default=1, help='Index of the class to inspect')
    parser.add_argument("--device", type=str, default=0 , help='Default device to perform computation on')
