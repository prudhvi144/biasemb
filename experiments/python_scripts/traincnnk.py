...
def parge_args():
    ...
    parser.set_defaults(
        ...
        gpu_id="0",
        dset="embryo",
        s_dset_txt="../../data/embryo/_train.txt",
        sv_dset_txt="../../data/embryo/_validation.txt",
...
def main():
    ...
    if not is_training:
        ...
        # model_path_for_testing = "/home/venom/PycharmProjects/MDNETS-V2.0/experiments/python_scripts/experiments/models/embryo/ResNet50/train_D_CNN/best_model.pth.tar"
        model_path_for_testing ="/home/venom/PycharmProjects/MDNETS-V2.0/experiments/python_scripts/experiments/models/embryo/ResNet50/train_Source_new_CNN/best_model.pth.tar"
